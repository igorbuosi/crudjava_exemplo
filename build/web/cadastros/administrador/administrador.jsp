...
<script>
     ...
     $(document).ready(function() {
        ...
        function carregarPessoa(v){
            console.log('Entrou na funcao carregarPessoa do adminsitrador.jsp | paramtro v: '+v)
            var idM = v;
                            ...
                            function(data){
                                if (data == 1){
                                    ...
                                    Swal.fire({
                                        ...
                                        icon: 'error',
                                        title: 'Erro',
                                        text: 'Não foi possível inativar adminsitrador',
                                        showConfirmButton: true,
                                        timer : 10000           
                                    }).then(function(){
                                        window.location.href="${pageContext.request.contextPath}/AdministradorListar";
                    ...
                    function (data){
                        ...
                        if (data == 1){
                             Swal.fire({
                                ...
                                icon: 'success',
                                title: 'Sucesso',
                                text: 'Adminsitrador gravado com sucesso',
                                showConfirmButton: true,
                                timer : 10000
                            }).then(function(){
                                window.location.href="${pageContext.request.contextPath}/AdministradorListar";
                            ...
                            Swal.fire({
                                ...
                                icon: 'error',
                                title: 'Erro',
                                text: 'Nao foi possível gravar adminsitrador!',
                                showConfirmButton: true,
                                timer : 10000
                            }).then(function(){
                                window.location.href="${pageContext.request.contextPath}/AdministradorListar";
