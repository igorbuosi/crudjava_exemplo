...
<script>
     ...
     $(document).ready(function() {
        ...
        function carregarPessoa(v){
            console.log('Entrou na funcao carregarPessoa do cliente.jsp | paramtro v: '+v)
            var idM = v;
            var tipoPessoa = 'cliente';   
            $(document).ready(function(){
                $.getJSON('PessoaBuscarCpfCnpj', {cpfcnpjpessoa: idM, tipopessoa: tipoPessoa}, function (respostaCliente){
                    console.log('resposta cliente ' + respostaCliente);
                    ...
                    function (data){
                        ...
                        if (data == 1){
                            ...
                            Swal.fire({
                                ...
                                icon: 'error',
                                title: 'Erro',
                                text: 'Nao foi possível gravar cliente!',
                                showConfirmButton: true,
                                timer : 10000
                            }).then(function(){
                                window.location.href="${pageContext.request.contextPath}/ClienteListar";
